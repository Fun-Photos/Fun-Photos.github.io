...
}, $ = (r) => [g.prefix, r, g.suffix].filter((e) => e && e.length > 0).join("-"), Z = (r) => {
...
async function ie(r, e) {
  ...
  }, o = e ? e(n) : n, a = ae() ? s.body : await s.blob();
...
class pe {
  ...
  handleAll(e) {
    ...
    const t = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, n = "params" in e ? e.params : void 0, o = new de(this, { event: t, request: s, params: n }), a = this._getResponse(o, s, t), i = this._awaitComplete(a, o, s, t);
    return [a, i];
  }
...
const N = self, S = `cache${U}`, j = q.concat(V), $e = new Set(j), ke = [
  "/",
  ...q,
  ...V,
  ...I
...
N.addEventListener("fetch", (r) => {
  if (r.request.method !== "GET" || r.request.headers.has("range"))
    return;
  const e = new URL(r.request.url), t = e.protocol.startsWith("http"), s = e.hostname === self.location.hostname && e.port !== self.location.port, n = e.host === self.location.host && $e.has(e.pathname), o = r.request.cache === "only-if-cached" && !n;
