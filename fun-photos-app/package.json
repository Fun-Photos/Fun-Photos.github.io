const q = [
        "/app/immutable/chunks/0-7f991fcd.js",
        "/app/immutable/chunks/1-76bb2881.js",
        "/app/immutable/chunks/2-15c853a4.js",
        "/app/immutable/chunks/3-532f11ce.js",
        "/app/immutable/chunks/index-d4ff72c6.js",
        "/app/immutable/chunks/singletons-4b23d8b5.js",
        "/app/immutable/start-c40afddc.js",
        "/app/immutable/components/error.svelte-e6cfd883.js",
        "/app/immutable/assets/_layout-1f1af934.css",
        "/app/immutable/components/pages/_layout.svelte-2b0efb65.js",
        "/app/immutable/assets/_page-242694ee.css",
        "/app/immutable/components/pages/_page.svelte-63ca46e9.js",
        "/app/immutable/components/pages/about/_page.svelte-0a4fbb08.js"
    ],
    V = [
        "/favicon.png",
        "/icon.png",
...
const W = {
    ...
    H = process.env.NODE_ENV === "production" ? M : F;
...
const B = (r, e) => {
    ...
    $ = (r) => [g.prefix, r, g.suffix].filter((e) => e && e.length > 0).join("-"),
    Z = (r) => {
...
function ne(r) {
    const e = r.length;
    e > 0 && (c.groupCollapsed(`During precaching cleanup, ${e} cached request${e === 1 ? " was" : "s were"} deleted.`), se("Deleted Cache Requests", r), c.groupEnd());
}
...
async function ce(r, e, t, s) {
    const n = D(e.url, t);
    if (e.url === n)
        return r.match(e, s);
    const o = Object.assign(Object.assign({}, s), { ignoreSearch: !0 }),
        a = await r.keys(e, o);
    for (const i of a) {
        const l = D(i.url, t);
        if (n === l)
...
async function ue() {
    process.env.NODE_ENV !== "production" && c.log(`About to run ${P.size} callbacks to clean up caches.`);
    for (const r of P)
...
class de {
    ...
    constructor(e, t) {
            ...
            }), Object.assign(this, t), this.event = t.event, this._strategy = e, this._handlerDeferred = new le(), this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = /* @__PURE__ */ new Map();
    ...
    async cachePut(e, t) {
            ...
            if (process.env.NODE_ENV !== "production") {
                ...
                const p = t.headers.get("Vary");
                p && c.debug(`The response for ${h(n.url)} has a 'Vary: ${p}' header. Consider setting the {ignoreVary: true} option on your strategy to ensure cache matching and deletion works as expected.`);
            }
            if (!t)
            ...
            const { cacheName: a, matchOptions: i } = this._strategy, l = await self.caches.open(a), w = this.hasCallback("cacheDidUpdate"), m = w ? await ce(
                // TODO(philipwalton): the `__WB_REVISION__` param is a precaching
                // feature. Consider into ways to only add this behavior if using
                // precaching.
                l,
                n.clone(), ["__WB_REVISION__"],
                i
            ) : null;
            ...
            try {
                ...
                if (p instanceof Error)
                    throw p.name === "QuotaExceededError" && await ue(), p;
            }
...
class pe {
    ...
    handleAll(e) {
        ...
        const t = e.event,
            ...
            o = new de(this, { event: t, request: s, params: n }),
            a = this._getResponse(o, s, t),
            i = this._awaitComplete(a, o, s, t);
        return [a, i];
    }
...
class y extends pe {
     ...
     */
    constructor(e = {}) {
            e.cacheName = T.getPrecacheName(e.cacheName), super(e), this._fallbackToNetwork = e.fallbackToNetwork !== !1, this.plugins.push(y.copyRedirectedCacheableResponsesPlugin);
        }
        /**
         * @private
...
y.copyRedirectedCacheableResponsesPlugin = {
    async cacheWillUpdate({ response: r }) {
        return r.redirected ? await ie(r) : r;
    }
};
class fe {
    /**
    ...
    addToCacheList(e) {
            ...
            for (const s of e) {
                ...
                const { cacheKey: n, url: o } = ee(s), a = typeof s != "string" && s.revision ? "reload" : "default";
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
    ...
    install(e) {
            return O(e, async() => {
                ...
                for (const [o, a] of this._urlsToCacheKeys) {
                    const i = this._cacheKeysToIntegrities.get(a),
                        l = this._urlsToCacheModes.get(o),
                        w = new Request(o, {
                            integrity: i,
                            cache: l,
                ...
                return process.env.NODE_ENV !== "production" && oe(s, n), { updatedURLs: s, notUpdatedURLs: n };
            });
        }
        /**
    ...
    activate(e) {
            return O(e, async() => {
                ...
                return process.env.NODE_ENV !== "production" && ne(o), { deletedURLs: o };
            });
        }
        /**
...
class E {
    ...
    constructor(e, t, s = A) {
            process.env.NODE_ENV !== "production" && (d.isType(e, "function", {
                ...
                funcName: "constructor",
                paramName: "match"
            }), s && d.isOneOf(s, ge, { paramName: "method" })), this.handler = C(t), this.match = e, this.method = s;
        }
        /**
         *
         * @param {workbox-routing-handlerCallback} handler A callback
...
class me {
    ...
    handleRequest({ request: e, event: t }) {
            ...
            const n = s.origin === location.origin,
                { params: o, route: a } = this.findMatchingRoute({
                    event: t,
                    request: e,
                    sameOrigin: n,
                    url: s
            ...
            process.env.NODE_ENV !== "production" && (c.groupCollapsed(`Router is responding to: ${h(s)}`), l.forEach((f) => {
                Array.isArray(f) ? c.log(...f) : c.log(f);
            }), c.groupEnd());
            let m;
            try {
                m = i.handle({ url: s, request: e, event: t, params: o });
            } catch (f) {
                m = Promise.reject(f);
            }
            const p = a && a.catchHandler;
            return m instanceof Promise && (this._catchHandler || p) && (m = m.catch(async(f) => {
                if (p) {
                    process.env.NODE_ENV !== "production" && (c.groupCollapsed(`Error thrown when responding to:  ${h(s)}. Falling back to route's Catch Handler.`), c.error("Error thrown by:", a), c.error(f), c.groupEnd());
                    try {
                        return await p.handle({ url: s, request: e, event: t, params: o });
                    } catch (x) {
                        x instanceof Error && (f = x);
                    }
                }
                if (this._catchHandler)
                    return process.env.NODE_ENV !== "production" && (c.groupCollapsed(`Error thrown when responding to:  ${h(s)}. Falling back to global Catch Handler.`), c.error("Error thrown by:", a), c.error(f), c.groupEnd()), this._catchHandler.handle({ url: s, request: e, event: t });
                throw f;
            })), m;
        }
        /**
...
let R;
const ye = () => (R || (R = new me(), R.addFetchListener(), R.addCacheListener()), R);
...
function be(r, e, t) {
    ...
    if (typeof r == "string") {
        ...
        if (process.env.NODE_ENV !== "production") {
            ...
            const i = r.startsWith("http") ? o.pathname : r,
                l = "[*:?+]";
...
function* Ee(r, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: t = "index.html", cleanURLs: s = !0, urlManipulation: n } = {}) {
    const o = new URL(r, location.href);
    o.hash = "", yield o.href;
    const a = Re(o, e);
...
Ce(ke);
N.addEventListener("install", (r) => {
    r.waitUntil(caches.open(S).then((e) => e.addAll(j)).then(() => {
        N.skipWaiting();
    }));
});
N.addEventListener("activate", (r) => {
    r.waitUntil(caches.keys().then(async(e) => {
        for (const t of e)
            t !== S && await caches.delete(t);
        N.clients.claim();
    }));
});
async function Ue(r) {
    const e = await caches.open(`offline${U}`);
    try {
        const t = await fetch(r);
        return e.put(r, t.clone()), t;
    } catch (t) {
        const s = await e.match(r);
        if (s)
            return s;
        throw t;
    }
}
N.addEventListener("fetch", (r) => {
    if (r.request.method !== "GET" || r.request.headers.has("range"))
        return;
    const e = new URL(r.request.url),
        t = e.protocol.startsWith("http"),
        s = e.hostname === self.location.hostname && e.port !== self.location.port,
        n = e.host === self.location.host && $e.has(e.pathname),
        o = r.request.cache === "only-if-cached" && !n;
    t && !s && !o && r.respondWith((async() => n && await caches.match(r.request) || Ue(r.request))());
});